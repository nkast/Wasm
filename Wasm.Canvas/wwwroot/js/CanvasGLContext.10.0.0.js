window.nkCanvasGLContext =
{
    ...
    CompressedTexImage2D: function(uid, module, d)
    {
        ...
        var arrPtr = module.HEAP32[(d+24)>>2];
    ...
    ReadPixels: function(uid, module, d)
    {
        ...
        var arrPtr = module.HEAP32[(d+28)>>2];
    ...
    BufferSubData: function(uid, module, d)
    {
        ...
        var arrPtr = module.HEAP32[(d+20)>>2];
...
window.nkCanvasGL2Context =
{
    ...
    GetBufferSubData1: function(uid, module, d)
    {
        ...
        var arrPtr = module.HEAP32[(d+16)>>2];
    ...
    TexSubImage3D: function (uid, module, d)
    {
        ...
        var arrPtr = module.HEAP32[(d+44)>>2];
    ...
    CompressedTexSubImage3D: function (uid, module, d)
    {
        ...
        var arrPtr = module.HEAP32[(d+40)>>2];
