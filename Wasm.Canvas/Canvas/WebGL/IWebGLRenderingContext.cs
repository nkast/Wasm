...
namespace nkast.Wasm.Canvas.WebGL
{
    public interface IWebGLRenderingContext : IRenderingContext
    {
        ...
        void TexImage2D<TData>(WebGLTextureTarget target, int level, WebGLInternalFormat internalFormat, int width, int height, WebGLFormat format, WebGLTexelType type, Span<TData> pixels) where TData : struct;
        ...
        void TexSubImage2D<TData>(WebGLTextureTarget target, int level, int xoffset, int yoffset, int width, int height, WebGLFormat format, WebGLTexelType type, Span<TData> pixels) where TData : struct;
        ...
        void CompressedTexImage2D<TData>(WebGLTextureTarget target, int level, WebGLInternalFormat internalFormat, int width, int height, Span<TData> pixels) where TData : struct;
        ...
        void CompressedTexSubImage2D<TData>(WebGLTextureTarget target, int level, int xoffset, int yoffset, int width, int height, WebGLFormat format, Span<TData> pixels) where TData : struct;
        ...
        void ReadPixels<TData>(int x, int y, int width, int height, WebGLFormat format, WebGLTexelType type, Span<TData> pixels) where TData : struct;
        ...
        void Uniform1iv<TData>(WebGLUniformLocation location, Span<TData> value) where TData : struct;
        void Uniform2iv<TData>(WebGLUniformLocation location, TData[] value) where TData : struct;
        void Uniform2iv<TData>(WebGLUniformLocation location, Span<TData> value) where TData : struct;
        void Uniform3iv<TData>(WebGLUniformLocation location, TData[] value) where TData : struct;
        void Uniform3iv<TData>(WebGLUniformLocation location, Span<TData> value) where TData : struct;
        void Uniform4iv<TData>(WebGLUniformLocation location, TData[] value) where TData : struct;
        void Uniform4iv<TData>(WebGLUniformLocation location, Span<TData> value) where TData : struct;
        void Uniform1fv<TData>(WebGLUniformLocation location, TData[] value) where TData : struct;
        void Uniform1fv<TData>(WebGLUniformLocation location, Span<TData> value) where TData : struct;
        void Uniform2fv<TData>(WebGLUniformLocation location, TData[] value) where TData : struct;
        void Uniform2fv<TData>(WebGLUniformLocation location, Span<TData> value) where TData : struct;
        void Uniform3fv<TData>(WebGLUniformLocation location, TData[] value) where TData : struct;
        void Uniform3fv<TData>(WebGLUniformLocation location, Span<TData> value) where TData : struct;
        void Uniform4fv<TData>(WebGLUniformLocation location, TData[] value) where TData : struct;
        void Uniform4fv<TData>(WebGLUniformLocation location, Span<TData> value) where TData : struct;
        void UniformMatrix2fv<TData>(WebGLUniformLocation location, TData[] value) where TData : struct;
        void UniformMatrix2fv<TData>(WebGLUniformLocation location, Span<TData> value) where TData : struct;
        void UniformMatrix3fv<TData>(WebGLUniformLocation location, TData[] value) where TData : struct;
        void UniformMatrix3fv<TData>(WebGLUniformLocation location, Span<TData> value) where TData : struct;
        void UniformMatrix4fv<TData>(WebGLUniformLocation location, TData[] value) where TData : struct;
        void UniformMatrix4fv<TData>(WebGLUniformLocation location, Span<TData> value) where TData : struct;
        ...
        void BufferData<TData>(WebGLBufferType type, Span<TData> data, WebGLBufferUsageHint usage) where TData : struct;
        void BufferSubData<TData>(WebGLBufferType target, int offset, TData[] srcData, int length) where TData : struct;
        void BufferSubData<TData>(WebGLBufferType target, int offset, Span<TData> srcData) where TData : struct;
