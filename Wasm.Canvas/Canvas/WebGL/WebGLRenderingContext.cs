...
namespace nkast.Wasm.Canvas.WebGL
{
    internal class WebGLRenderingContext : RenderingContext, IWebGLRenderingContext, IDisposable
    {
            ...
            where TData : struct
        {
            ...
            Invoke("nkCanvasGLContext.TexImage2D1", (int)target, level, (int)internalFormat, width, height, (int)format, (int)type, stride, pixels.Length, pixels);
        }
            ...
            where TData : struct
        {
            ...
            Invoke("nkCanvasGLContext.TexSubImage2D1", (int)target, level, position, width, height, (int)format, (int)type, stride, pixels.Length, pixels);
        }
        ...
        {
            var stride = Marshal.SizeOf<TData>();
            Invoke("nkCanvasGLContext.BufferData1", (int)type, (int)usage, stride, data.Length, data);
        }
