...
namespace AudioWorklet.Pages
{
    public partial class Index : IDisposable
    {
        ...
        internal void SetbtnStartAudioWorklet(string text, bool disabled)
        {
            string textContentCmd = "document.getElementById('btnStartAudioWorklet').textContent = '" + text + "';";
            JsRuntime.InvokeAsync<string>("eval", textContentCmd);
            string disabledCmd = "document.getElementById('btnStartAudioWorklet').disabled = " + disabled.ToString().ToLower() + ";";
            JsRuntime.InvokeAsync<string>("eval", disabledCmd);
        }

        [JSInvokable]
        public static void btnStartAudioWorkletOnButtonClick()
        {
            _indexInstance._root.InitAudioWorkletAsync();
        }
